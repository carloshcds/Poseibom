  ...
  return (
    <View style={styles.telahome}>
      ...
      >
        ...
        <Text style={[styles.r1899, styles.r1899Typo]}>R$ 18,99</Text>
      ...
      >
        <Text style={[styles.porKg, styles.porTypo]}>Por Kg</Text>
        <Text style={[styles.r1899, styles.r1899Typo]}>R$ 24,99</Text>
        <Text style={[styles.filDeTilpia, styles.tilpiaClr]}>
      ...
      >
        ...
        <Text style={[styles.r1199, styles.r1899Typo]}>R$ 11,99</Text>
        <Image
          style={styles.imgtilpiafrescaIcon}
          contentFit="cover"
